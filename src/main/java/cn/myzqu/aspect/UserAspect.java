...
public class UserAspect {
    ...
    @Pointcut("execution(public * cn.myzqu.controller.NavController.user(..))")
    public void verify(){

    }

    @Before("execution(public * cn.myzqu.controller.NavController.user(..))")
    public void doVerify(JoinPoint jp) throws CustomException {
        System.out.println("开始执行验证user身份:"+jp.getSignature().getName());
